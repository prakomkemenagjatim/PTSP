			...
			$jtgllhr1 = implode('-',array_reverse(explode('-',$jtgllhr)));
				...
				if ($status == 5){
						...
						if ($result){
							...
							DATE_FORMAT(`traveltglsurat`,'%Y') as jsuraty  from vwsuruq where noreg = '$noreg'");
							$rowr = $resultr->row();
							...
							<tr class="style1" align="justify">
								<td colspan="3">Adalah calon jemaah Umroh yang terdaftar pada '.$rowr->travelnama.' yang tercatat sebagai Penyelenggara Perjalanan Ibadah Umroh yang resmi pada Kementerian Agama dengan Nomor 1376 TAHUN 2019 Tanggal 28 Oktober 2019. 
								</td>
							</tr>
							<tr class="style1" align="justify">
								<td colspan="3">

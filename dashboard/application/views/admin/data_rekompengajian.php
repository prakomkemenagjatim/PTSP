                ...
                <div class="col-md-4 padding-r-5 margin-t-10">
					<div class="form-group">
						...
						<div id="mm" style="width:200px">
							...
							<div data-options="name:'alamatpengiriman'">Alamat Pengiriman</div>
						</div>
					</div>
				</div>
        	</div>
					...
					<table id="dg" class="easyui-datagrid" style="height:550px"
							...
							<thead>
					            <tr>
					                ...
					                <th rowspan="2" data-options="field:'filedok',width:150,align:'center',formatter:formatlink" sortable="true">LINK SURAT</th>
									<th rowspan="2" data-options="field:'filedok1',width:150,align:'center',formatter:formatlink" sortable="true">LINK PROPOSAL &<br/> DENAH LOKASI</th>
					            </tr>
								<tr>
										...
										<div class="row margin-b-15">
											...
											<div class="col-lg-12 inpket">
												<div class="form-group margin-b-15">
													...
													<div class="row">
														<div class="col-lg-12">
															<span id="filesurat" name="filesurat" class="form-control frmtxt"></span>
														</div>
													</div>
												</div>
											</div>
											<div class="col-lg-12 inpket">
												<div class="form-group margin-b-15">
													<label for="inputdefault" class="lblket">
														File Proposal Kegiatan dan Denah Lokasi 
													</label>
													<div class="row">
														<div class="col-lg-12">

						...
						<form id="frmdok" action="" method="POST" enctype="multipart/form-data" >
							<div class='col-sm-12  mt-4'>
								<div class="form-group">
									<label for="nama" class="control-label text-muted">Nama pemohon/pengirim <sup class="text-danger">*</sup></label>
									<input type="text" class="form-control form-text" id="nama" name="nama" required>
								</div>    
							</div>  
							<div class='col-sm-12'>
								<div class="form-group">
									<label for="nowa" class="control-label text-muted">Nomor WA/HP pemohon/pengirim <sup class="text-danger">*</sup></label>
							...
							<div class='col-sm-12'>
								<div class="form-group">
									<label for="filedok" class="control-label text-muted">Upload file surat <small>( Tipe file: pdf, Ukuran Maks.: 500kb )</small> <sup class="text-danger">*</sup></label>
									<input type="file" class="form-control form-text" id="filedok" name="filedok" required>
								</div>    
							</div>
						</form>

					...
					<table id="dg" class="easyui-datagrid" style="height:550px"
							...
							<thead>
					            <tr>
					                ...
					                <th rowspan="2" data-options="field:'filedok',width:150,align:'center',formatter:formatlink" sortable="true">LINK SURAT<br/>PROPOSAL</th>
					            </tr>
								<tr>
											...
											<div class="col-lg-12 inpket">
												<div class="form-group margin-b-15">
													<label for="inputdefault" class="lblket">
														File Surat Permohonan & Proposal
													</label>
													<div class="row">
														<div class="col-lg-12">

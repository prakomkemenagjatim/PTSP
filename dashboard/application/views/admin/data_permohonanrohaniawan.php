...
<script type="text/javascript">
	...
	function progressLay(dispo){
		...
		if (row){
			...
			var urlfile = '<?php echo viewdoc().str_replace('dashboard/','',base_url()) ; ?>'+row.filedok;
			$('#filesurat').html('<a target="_blank" href="'+urlfile+'" class="btn btn-info" style="border-radius: 50px;padding: 5px 20px;margin: 5px;" ><span class="fa fa-link fa-fw"></span>Link file</a>');

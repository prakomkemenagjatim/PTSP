								...
								<div class="form-group">
									<div class="row">	
										<div class="col-lg-6 margin-t-10">
											<label>NPSN<span class="red-text">*</span></label>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$('#dg').datagrid({
	  	...
	  	$('#dg').datagrid({url:"<?php echo base_url('index.php/data/getSekolahkristen')?>",queryParams:{
...
//
	...
	function simpandata(){
		...
		url = "<?php echo base_url('index.php/data/postSekolahkristen')?>";
...
//
	...
	function hapusData(id,nama,jenjang){
			swal({
				  ...
				  var jpost = $.post("<?php echo base_url('index.php/data/delSekolahkristen')?>",
									{
										idx:id,
										nama:nama,
										jenjang:jenjang,

...
<script type="text/javascript">
	...
	$(document).ready(function(){ 
		...
		// })
		;
	  $('#dg').datagrid({url:"<?php echo base_url('index.php/data/getSuratmasuk2')?>",queryParams:{
	...
	function simpandata(){
		...
		formData.append('nowa',$('#nowa').html());
	...
	function exportdata(){
		$.post('<?php echo base_url("index.php/export/excelSuratmasuk"); ?>',{
			icari: scari.searchbox("getName"),
			ncari: scari.searchbox("getValue"),
			kd:kd,
			kd1:kd1,

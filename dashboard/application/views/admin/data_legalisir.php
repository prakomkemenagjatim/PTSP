					...
					<table id="dg" class="easyui-datagrid" style="height:550px"
							...
							<thead>
								...
								<th  rowspan="2" data-options="field:'ck',checkbox:true"></th>
					                ...
					                <th rowspan="2" data-options="field:'filedok',width:150,align:'center',formatter:formatlink" sortable="true">LINK PERMOHONAN</th>
					            </tr>
								<tr>
...
<script type="text/javascript">
	...
	function exportdata(){
		$.post('<?php echo base_url("index.php/export/excelLegalisir"); ?>',{
			icari: scari.searchbox("getName"),
			ncari: scari.searchbox("getValue"),
			kd:kd,
			kd1:kd1,

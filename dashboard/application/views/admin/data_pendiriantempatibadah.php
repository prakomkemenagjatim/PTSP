					...
					<table id="dg" class="easyui-datagrid" style="height:550px"
							...
							<thead>
								...
								<th  rowspan="2" data-options="field:'ck',checkbox:true"></th>
					                ...
					                <th rowspan="2" data-options="field:'filedok',width:150,align:'center',formatter:formatlink" sortable="true">LINK PROPOSAL</th>
									<th rowspan="2" data-options="field:'filedok1',width:150,align:'center',formatter:formatlink" sortable="true">LINK REKOMENDASI<br/> FKUB</th>
					            </tr>
								<tr>

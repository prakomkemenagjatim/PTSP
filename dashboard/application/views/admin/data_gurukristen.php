...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$('#dg').datagrid({
	  	...
	  	$('#dg').datagrid({url:"<?php echo base_url('index.php/data/getGuruagamakristen')?>",queryParams:{
	...
	function get_sekolah(el,vk,vl,sek){
	 $.post("<?php echo base_url();?>index.php/data/ajaxsekolahkristen",{kec:vk,kel:vl},function(obj){
			el.html(obj);
			el.val(sek);
	 });	
	}
	...
	function simpandata(){
		...
		url = "<?php echo base_url('index.php/data/postGuruagamakristen')?>";
...
/*	function exportexceltabel(){
	...
	function hapusData(id,nama,sekolah){
			swal({
				  ...
				  var jpost = $.post("<?php echo base_url('index.php/data/delGuruagamakristen')?>",
									{
										idx:id,
										iNama:nama,
										iSekolah:sekolah

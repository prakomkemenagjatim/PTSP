		...
		<div class="card-body">
			<div class="row">
				...
				<div class="col-md-3 col-xs-12 padding-r-5 margin-t-10">
					<div class="form-group">
                          <label for="search_tgl1"><sup>Type arsip</sup></label>
			...
			<div class="row">
				<div class="col-md-12 padding-lr-5 margin-t-10 easyui-layout">
					<table id="dg" class="easyui-datagrid" style="height:550px"
							...
							<thead>
					            <tr>
									<th   data-options="field:'berkasid',checkbox:true"></th>
									<!-- <th rowspan="2" data-options="field:'nourut',width:80,align:'center'" sortable="true"><b>NOMOR URUT</b></th> -->
									<th  data-options="field:'berkasnoreg',width:100,align:'center'" sortable="true"><b>NOMOR AGENDA</b></th>
									<th data-options="field:'suratno',width:250,align:'left'" sortable="true"><b>NOMOR SURAT</b></th>
									<th  data-options="field:'suratinstansi',width:270,align:'left'" sortable="true">ASAL SURAT</th>
									<th  data-options="field:'suratperihal',width:520,align:'left'" sortable="true">HAL SURAT</th>
									<th  data-options="field:'berkasfile',width:100,align:'center',formatter:formatdok" sortable="true">LINK<br/>BERKAS</th>
	...
	<div class="modal-dialog modal-lg" style="width: 100%;">
		<div class="modal-content">
			<div class="modal-header  bg-dark modal-header-primary border-btm">
				...
				<h4 id="judul" class="modal-title white-text">
					<?php echo $caption ?>
				</h4>
			</div>
		...
		$('#dg').datagrid({
			rowStyler:function(index,row){
				...
				if (row.status == 3){
					...
					return 'background-color:#fcfc03;';
				}
			}
		});
	  $('#dg').datagrid({url:"<?php echo base_url('index.php/data/getarsip')?>",queryParams:{

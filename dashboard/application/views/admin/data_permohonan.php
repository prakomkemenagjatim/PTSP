                ...
                <div class="col-md-4 padding-r-5 margin-t-10">
					<div class="form-group">
						...
						<div id="mm" style="width:200px">
							...
							<div data-options="name:'suratinstansi'">Instansi/Lembaga Surat/Permohonan</div>
							<div data-options="name:'suratperihal'">Perihal Surat/Permohonan</div>
					...
					<table id="dg" class="easyui-datagrid" style="height:550px"
							...
							<thead>
					            <tr>
									...
									<th rowspan="2" data-options="field:'suratinstansi',width:300" sortable="true">INSTANSI/LEMBAGA SURAT<br/>PERMOHONAN</th>
									<th rowspan="2" data-options="field:'suratperihal',width:300" sortable="true">PERIHAL SURAT<br/>PERMOHONAN</th>
...
<script type="text/javascript">
    ...
    rowStyler: function(index, row) {
        const statusColors = {
            1: '#FFEFD5', // Menunggu Persetujuan (PapayaWhip)
            2: '#90EE90', // Diterima (LightGreen)
            3: '#ADD8E6', // Masih Dalam Proses (LightBlue)
            4: '#FFB6C1', // Ditolak (LightPink)
            5: '#98FB98', // Selesai (PaleGreen)
            6: '#FFFFE0', // Menunggu Arahan (LightYellow)
            7: '#D8BFD8'  // Masuk Srikandi (Thistle)
        };
	...
	function exportdata(){
		$.post('<?php echo base_url("index.php/export/excelPermohonan"); ?>',{
			icari: scari.searchbox("getName"),
			ncari: scari.searchbox("getValue"),
			kd:kd,
			kd1:kd1,

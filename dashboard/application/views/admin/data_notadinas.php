			...
			<div class="row">        
				<div class="col-md-2 col-xs-12 padding-r-5 margin-t-10">
					<div class="form-group">
                          <label for="search_tgl">Periode Tgl.Nota</label>
						...
						<table id="dg" class="easyui-datagrid" style="height:550px"
								...
								<thead>
						            <tr>
										...
										<th data-options="field:'tgl',width:120,align:'center'" sortable="true">TGL.NOTA DINAS</th>
				...
				<div class="row">
					<div  class="col-lg-6">
						<div class="form-group">
							...
							<span id="nourut" name="nourut" type="text" class="form-control form-span" readonly><i>Automatis dibuat sistem</i></span>
						</div>
						<div class="form-group">
...
<script type="text/javascript">
	...
	$(document).ready(function(){ 
		...
		$('#dg').datagrid({url:"<?php echo base_url('index.php/data/getNotadinas')?>",queryParams:{
	...
	function simpanData(){
		...
		$.ajax({
				url:  "<?php echo base_url('index.php/data/notadinasPost')?>",
				type: 'POST',
				data: formData,
				async: false,
				cache: false,
	...
	function cleardata(){
		$('.form-text').val('');
		$('.form-span').html('');
		$('#nourut').html('<i>Automatis dibuat sistem</i>');
		$('#noagenda').hide();
		$('.select').val('');
	...
	function exportdata(){
		$.post('<?php echo base_url("index.php/export/excelNotadinas"); ?>',{
			icari: scari.searchbox("getName"),
			ncari: scari.searchbox("getValue"),
			tgl:sTgl.val(),
			tgl1:sTgl1.val(),

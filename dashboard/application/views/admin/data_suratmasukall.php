			...
			<div class="row">
                ...
                <div class="col-md-4 padding-r-5 margin-t-10">
					<div class="form-group">
						...
						<input id = "search_cari" class="easyui-searchbox" data-options="prompt:'Please Input Value',menu:'#mm',searcher:doSearch" style="width:100%;height: 35px;z-inde"></input>
				...
				<div class="row">
				<div class="col-md-2 col-xs-6 padding-lr-5 "> 
										...
										<?php if ($userSess['userType'] <= 1 ){?>
											...
											<div class="col-lg-12 nodispo">
												<div class="form-group margin-b-15">
													<div class="row">
														<div class="col-lg-12">
															<span id="disposisinm" class=""></span>
														</div>
													</div>
												</div>
											</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){ 
	  ...
	  $('#dg').datagrid({url:"<?php echo base_url('index.php/data/getSuratmasukrekap')?>",queryParams:{
	...
	function loadberkas(noreg){
		...
		$.post("<?php echo base_url('index.php/data/getBerkas')?>",{noreg:noreg},function(rest){
			...
			$.each( rest, function( key, value ) {
				...
				$('#berkas').append(`<div class="col-lg-12 ">
										<label>${berkasket}</label>
										<span id="filesurat" name="filesurat" class=" frmtxt">
											<a target="_blank" href="${urlfile}" class="btn btn-info" style="border-radius: 50px;" ><span class="fa fa-link fa-fw"></span>Link Dokumen</a>
										</span>							
									</div>`);
				i++;
			});

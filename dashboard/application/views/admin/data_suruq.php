  ...
  <div class="col-md-12 stretch-card">
		...
		<div class="card-body">
                ...
                <div class="col-md-4 padding-r-5 margin-t-10">
					<div class="form-group">
						...
						<div id="mm" style="width:200px">
							...
							<div data-options="name:'pemohonnama'">Nama Lengkap Pemohon</div>
							<div data-options="name:'pemohonnowa'">No. WA/HP Pemohon</div>
							<div data-options="name:'travelnama'">Nama Travel</div>
							<div data-options="name:'travelnosk'">No.SK Travel</div>
							<div data-options="name:'traveltglsk'">Tgl.SK Travel</div>
							<div data-options="name:'jamaahnama'">Nama Jamaah</div>
							<div data-options="name:'jamaahlhrtmp'">Tmpt.Lahir Jamaah</div>
							<div data-options="name:'jamaahlhrtgl'">Tgl.Lahir Jamaah</div>
							<div data-options="name:'jamaahalamat'">Alamat Jamaah</div>
							<div data-options="name:'jamaahhp'">HP Jamaah</div>
			...
			<div class="row">
					...
					<table id="dg" class="easyui-datagrid" style="height:550px"
							...
							<thead>
					            <tr>
									...
									<th rowspan="2" data-options="field:'pemohonnama',width:250" sortable="true">NAMA LENGKAP PEMOHON</th>
									<th rowspan="2" data-options="field:'pemohonhp',width:200" sortable="true">NO.HP/WA PEMOHON</th>
								...
								<tr>
									...
									<th data-options="field:'travelnama',width:250" sortable="true">NAMA</th>
									<th data-options="field:'travelnosurat',width:150" sortable="true">NOMOR SURAT</th>
									<th data-options="field:'traveltglsurat1',width:150,align:'center'" sortable="true">TGL SURAT</th>

									<th data-options="field:'jamaahnama',width:250" sortable="true">NAMA</th>
									<th data-options="field:'jamaahlhrtmp',width:150" sortable="true">TEMPAT LAHIR</th>
									<th data-options="field:'jamaahlhrtgl1',width:150,align:'center'" sortable="true">TGL LAHIR</th>
									<th data-options="field:'jamaahalamat',width:150" sortable="true">ALAMAT</th>
									<th data-options="field:'jamaahhp',width:150" sortable="true">HP</th>
								</tr>
					        </thead>
					</table>
				</div>
				...
				<style>
					#box1{display: flex;align-items: center;font-size: 12px;}div#box1:before{content: '';background-color: #fff;border-radius: 50%;border-width: 5px;height: 20px;width: 20px;}#box2{display: flex;align-items: center;font-size: 12px;}div#box2:before{content: '';background-color: #f0f4c3;border-radius: 50%;border-width: 5px;height: 20px;width: 20px;}#box3{display: flex;align-items: center;font-size: 12px;}div#box3:before{content: '';background-color: #bbdefb;border-radius: 50%;border-width: 5px;height: 20px;width: 20px;}#box4{display: flex;align-items: center;font-size: 12px;}div#box4:before{content: '';background-color: #ffcdd2;border-radius: 50%;border-width: 5px;height: 20px;width: 20px;}#box5{display: flex;align-items: center;font-size: 12px;}div#box5:before{content: '';background-color: #c8e6c9;border-radius: 50%;border-width: 5px;height: 20px;width: 20px;}
				</style>
			<div class="row">
										...
										<div class="row margin-b-15">
											...
											<div class="col-lg-12">
												<div class="form-group margin-b-15">
													...
													<div class="row">
														<div class="col-lg-12">
															<select class="form-control form-text select selectpicker"  id="travel" name="travel" data-live-search="true">
																<option value="" data-sk="" data-tglsk="">-Pilih Travel-</option>
																<?php echo optionTravel(); ?>
															</select>
														</div>
													</div>
												</div>
											...
											<div class="col-lg-12">
												<div class="form-group margin-b-15">
													...
													<div class="row">
														<div class="col-lg-12">
														<input type="text" class="form-control form-text" id="nosurat" name="nosurat" >
														</div>
													</div>
												</div>
											</div>
											<div class="col-lg-12">
												<div class="form-group margin-b-15">
													<label for="inputdefault">
														Tanggal surat travel
													</label>
													<div class="row">
														<div class="col-lg-12">
															<input type="text" class="form-control form-text datepicker" id="tglsurat" name="tglsurat" readonly >
														</div>
													</div>
												</div>
											</div>
											<div class='col-sm-12 '>
												<div class="form-group mt-2 mb-1">
													<sup class="control-label text-black">Identitas Jamaah</sup>
												</div>    
											</div>
											<div class="col-lg-12">
												<div class="form-group margin-b-15">
													...
													<div class="row">
														<div class="col-lg-12">
															<input type="text" class="form-control form-text" id="jnama" name="jnama" required>
														</div>
													</div>
												</div>
											</div>
											<div class="col-lg-12">
												<div class="form-group margin-b-15">
													...
													<div class="row">
														<div class="col-lg-12">
															<input type="text" class="form-control form-text" id="jtmplhr" name="jtmplhr" required>
														</div>
													</div>
												</div>
											</div>
											<div class="col-lg-12">
												<div class="form-group margin-b-15">
													<label for="inputdefault">
														Tanggal lahir jamaah
													</label>
													<div class="row">
														<div class="col-lg-12">
															<input type="text" class="form-control form-text datepicker" id="jtgllhr" name="jtgllhr" required>
														</div>
													</div>
												</div>
											</div>
											<div class="col-lg-12">
												<div class="form-group margin-b-15">
													...
													<div class="row">
														<div class="col-lg-12">
															<input type="text" class="form-control form-text" id="jalamat" name="jalamat" required>
														</div>
													</div>
												</div>
											</div>
											<div class="col-lg-12">
												<div class="form-group margin-b-15">
													<label for="inputdefault">
														Nomor handphone jamaah
													</label>
													<div class="row">
														<div class="col-lg-12">
															<input type="text" class="form-control form-text" id="jhp" name="jhp" required>
														</div>
													</div>
												</div>
											</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){ 
	  ...
	  $('#dg').datagrid({url:"<?php echo base_url('index.php/data/getSuruq')?>",queryParams:{
		...
		// $('#travel').on('changed.bs.select', function (e, clickedIndex, isSelected, previousValue) {
		// 	$('#nosk').val($('option:selected', this).attr("data-sk"));
		// 	$('#tglsk').val($('option:selected', this).attr("data-tglsk"));
	...
	function progressLay(dispo){
		...
		if (row){
			...
			$('#nowa').html(row.pemohonhp);

			$('#travel').val(row.travelid);
			$('.selectpicker').selectpicker('refresh');
			$('#nosurat').val(row.travelnosurat);
			$('#tglsurat').val(row.traveltglsurat1);
			$('#jnama').val(row.jamaahnama);
			$('#jtmplhr').val(row.jamaahlhrtmp);
			$('#jtgllhr').val(row.jamaahlhrtgl1);
			$('#jalamat').val(row.jamaahalamat);
			$('#jhp').val(row.jamaahhp);
	...
	function simpandata(){
		...
		formData.append('travel',$('#travel').val());
		formData.append('nosurat',$('#nosurat').val());
		formData.append('tglsurat',$('#tglsurat').val());
		formData.append('jnama',$('#jnama').val());
		formData.append('jtmplhr',$('#jtmplhr').val());
		formData.append('jtgllhr',$('#jtgllhr').val());
		formData.append('jalamat',$('#jalamat').val());
		formData.append('jhp',$('#jhp').val());
		$.ajax({
				url:  "<?php echo base_url('index.php/data/suruqPost')?>",
				type: 'POST',
				data: formData,
				async: false,
				cache: false,
		...
		if (row){
			...
			if (noreg != '' && noreg != null && dispo != 'null'){
				if (dispo != '' && dispo != null && dispo != 'null'){
					...
					window.open('<?php echo base_url('index.php/data/viewdoc?file=').base_url(); ?>index.php/data/lembardisposisi?q='+noreg, "_blank");
				} else {
	...
	function exportdata(){
		$.post('<?php echo base_url("index.php/export/excelSuruq"); ?>',{
			icari: scari.searchbox("getName"),
			ncari: scari.searchbox("getValue"),
			kd:kd,
			kd1:kd1,

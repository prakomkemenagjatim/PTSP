...
<ul class="nav">
  ...
  <li class="nav-item"><a class="nav-link nav-head" href="<?php echo base_url('index.php/data/rekapsuratmasuk')?>"><img class="menu-iconx" src="<?php echo base_url('assets/images/menu_icons/07.png')?>" alt="menu icon"><span class="menu-title">Rekap Surat Masuk  </span></a></li>
  <?php //}?>  
  <!-- <i>{Beta}</i> -->
  ...
  <?php if ($userSess['userType'] < 13  ){?>
    ...
    <img class="menu-iconx" src="<?php echo base_url('../assets/images/menu_icons/v3/subagtu.png')?>" alt="menu icon"> <span class="menu-title">Sekretariat <i class="fa fa-envelope red-text m01" style="display:none" aria-hidden="true"></i></span><i class="menu-arrow"></i></a>
...
<li class="nav-item"><a class="nav-link" href="<?php echo base_url('index.php/data/suratmasuk/').$row->layananView;?>"><img class="menu-iconx" src="<?php echo base_url('assets/images/menu_icons/04.png')?>" alt="menu icon"><span class="menu-title"><?php echo ucwords(strtolower($row->layananJenis));?>&nbsp;<i class="m<?php echo $row->menuKode.$row->layananKode;?>" style="display:none" aria-hidden="true"> <span class="count-indicator"><span class="count c<?php echo $row->menuKode.$row->layananKode;?>">0</span></span></i></span></a></li>
  ...
  <?php if ($userSess['userType'] < 2 ||  $userSess['userType'] == 3 ){?>
    ...
    <img class="menu-iconx" src="<?php echo base_url('../assets/images/menu_icons/v3/bimasislam.png')?>" alt="menu icon"> <span class="menu-title">Bimas Islam <i class="fa fa-envelope red-text m02" style="display:none" aria-hidden="true"></i></span><i class="menu-arrow"></i></a>
...
?> 
  ...
  <li class="nav-item">
    ...
    <img class="menu-iconx" src="<?php echo base_url('../assets/images/menu_icons/v3/hajiumrah.png')?>" alt="menu icon"> <span class="menu-title">Haji & Umrah <i class="fa fa-envelope red-text m03" style="display:none" aria-hidden="true"></i></span><i class="menu-arrow"></i></a>
...
?> 
  ...
  <li class="nav-item">
    ...
    <img class="menu-iconx" src="<?php echo base_url('../assets/images/menu_icons/v3/zakatwakaf.png')?>" alt="menu icon"> <span class="menu-title">Zakat & Wakaf <i class="fa fa-envelope red-text m07" style="display:none" aria-hidden="true"></i></span><i class="menu-arrow"></i></a>
...
?> 
  ...
  <?php if ($userSess['userType'] < 2 ||  $userSess['userType'] == 10 ){?>
    ...
    <span class="menu-title">Layanan Kristen <i class="fa fa-envelope red-text m08" style="display:none" aria-hidden="true"></i></span><i class="menu-arrow"></i></a>
  ...
  <?php if ($userSess['userType'] < 2 ||  $userSess['userType'] == 9 ){?>
    ...
    <span class="menu-title">Layanan Buddha <i class="fa fa-envelope red-text m09" style="display:none" aria-hidden="true"></i></span><i class="menu-arrow"></i></a>
  ...
  <?php if ($userSess['userType'] < 2 ||  $userSess['userType'] == 11 ){?>
    ...
    <span class="menu-title">Layanan Katolik <i class="fa fa-envelope red-text m10" style="display:none" aria-hidden="true"></i></span><i class="menu-arrow"></i></a>

				...
				<form id="frmdok" action="" method="POST" enctype="multipart/form-data" >
					...
					<div class="row justify-content-center">
						<div class='col-sm-6 text-left box-shadow-dark'>
							...
							<div class='col-sm-12'>
								<div class="form-group">
									<label for="nowa" class="control-label text-muted">Nomor WA/HP Pemohon <sup class="text-danger">*</sup><br><small>( contoh: 08123456789 )</small></label>
							...
							<div class='col-sm-12'>
								<div class="form-group">
									<label for="nomorsurat" class="control-label text-muted">Nomor Paspor dan Visa <sup class="text-danger">*</sup></label>
									<input type="text" class="form-control form-text" id="nomorsurat" name="nomorsurat" required>
								</div>    
							</div>
							<div class='col-sm-12'>
								<div class="form-group">
									<label for="tujuansurat" class="control-label text-muted">Alamat selama di indonesia <sup class="text-danger">*</sup></label>
							...
							?>
								<div class='col-sm-12'>
									<div class="form-group">
										...
										<input type="file" class="form-control form-text"  name="berkas[]" accept=".pdf" required>
									</div>    
								</div>
							<?php
										$i++;
...
//
	...
	function simpandata(){
		...
		setTimeout(function(){
			$.ajax({
					url:  "<?php echo base_url('index.php/ajax/tenagaagamaasingPost')?>",
					type: 'POST',
					data: formData,
					async: false,
					cache: false,

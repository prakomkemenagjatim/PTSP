    ...
    <div class="page-header  py-5 text-center position-relative bg-secondary  box-shadow-dark">
	    ...
	    <div class="container "style="padding-top: 3rem;padding-bottom:3rem">
			...
			<div class="w-100">
				<form id="frmdok" action="" method="POST" enctype="multipart/form-data" >
					<div class="row justify-content-center">
						<div class='col-sm-6 text-left box-shadow-dark'>
							<div class="rounded bg-layanan p-3 mt-4">
								<small class="text-warning"> SYARAT DAFTAR HAJI REGULER:</small>
								<small>
								<ol class="text-muted">
								<li>Beragama Islam.</li>
								<li>Berusia minimal 12 tahun pada saat mendaftar.</li>
								<li>Belum berangkat haji dalam 10 tahun terakhir.</li>
								</ol>
								</small>
							</div>
							<div class="rounded bg-dark p-3 mt-4 mb-4">
								<small class="text-warning"> ALUR PENDAFTARAN HAJI ONLINE:</small>
								<small>
								<ol class="text-muted">
								<li>Calon jamaah haji melakukan setoran awal sebesar 25 Juta ke rekening atas nama Badan pengelola Keuangan Haji di BPS BIPIH (atau bank yang telah tersedia di Kantor Kementerian Agama Kota Malang).</li>
								<li>Setelah melakukan setoran awal 25 juta calon jamaah haji mendapatkan bukti validasi dari BPS.</li>
								<li>Upload berkas pendaftaran dan setelah mendapat bukti validasi oleh petugas kemenag, dilanjutkan dengan datang langsung ke kemenag dengan membawa berkas asli untuk melakukan biometrik dan Finger serta mendapatkan Surat Pendaftaran Pergi Haji (SPPH)/ nomor porsi.</li>
								<li>Menunggu dan selalu menjaga kesehatan sampai panggilan pemberangkatan haji.</li>
								</ol>
								</small>
							</div>
						...
						<div class='col-sm-6 text-left box-shadow-dark'>
							...
							<div class='col-sm-12'>
								<div class="form-group">
									<label for="nomorsurat" class="control-label text-muted">Nomor Surat</label>
									<input type="text" class="form-control form-text" id="nomorsurat" name="nomorsurat" required>
								</div>    
							</div>
							<div class='col-sm-12'>
								<div class="form-group">
									<label for="tglsurat" class="control-label text-muted">Tanggal Surat/Permohonan <sup class="text-danger">*</sup></label>
							...
							<div class='col-sm-12'>
								<div class="form-group">
									<label for="perihalsurat" class="control-label text-muted">Perihal Surat/Permohonan <sup class="text-danger">*</sup></label>
					...
					<div class="row justify-content-center">
						...
						<div class='col-md-6 col-sm-12 text-left box-shadow-dark pt-4 mt-2'>
							<?php
								$arrket = json_decode($ketlampiran,true);
								if (count($arrket) > 0){
									echo '<label class="control-label text-warning">Dokumen yang harus diupload:</label>';
									$i = 1;
				...
				<div class="row justify-content-center">
					<div class='col-sm-6'></div>
					<div class='col-md-6 col-sm-12 text-left box-shadow-dark mt-2'>

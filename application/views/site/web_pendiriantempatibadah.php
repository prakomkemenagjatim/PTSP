				...
				<div class="row justify-content-center">
					<div class='col-sm-6 text-left box-shadow-dark'>
						...
						<header class="section-header mt-4">
							...
							<div class='col-sm-12'>
								<div class="form-group">
									<label for="file1" class="control-label text-muted">Upload file proposal <sup class="text-danger">*</sup><br/> 
									<small>( Tipe file: pdf, Ukuran Maks.: <?php echo sizeupload(); ?> )</small><br/>
									<small class="text-danger">File Proposal yang memuat letak geografis daerah yang akan didirikan tempat ibadah, peta lokasi, gambaran umum tentang masyarakat sekitar, daftar nama dan ktp pengguna rumah ibadah paling sedikit 90 orang, daftar dukungan masyarkat setempat minimal 60 orang, copy sertifikat tanah.</small>
									</label>
							...
							<div class='col-sm-12'>
								<div class="form-group">
									<label for="file2" class="control-label text-muted">Upload file rekomendasi FKUB <sup class="text-danger">*</sup> <br/> 
									<small>( Tipe file: pdf, Ukuran Maks.: <?php echo sizeupload(); ?> )</small></label>
									<input type="file" class="form-control form-text" id="file2" name="file2" required>
								</div>    
							</div>
						</form>
						<div class='col-sm-12'>
...
<script type="text/javascript">
	...
	function simpandata(){
		...
		setTimeout(function(){
			$.ajax({
					url:  "<?php echo base_url('index.php/ajax/pendiriantempatibadahPost')?>",
					type: 'POST',
					data: formData,
					async: false,
					cache: false,

				...
				<form id="frmdok" action="" method="POST" enctype="multipart/form-data" >
					...
					<div class='col-sm-6 text-left box-shadow-dark <?php echo $dnoneket; ?>'>
						...
						<div class='col-sm-6 text-left box-shadow-dark'>
							...
							<label class="control-label text-warning mt-4">Travel:</label>
							<div class='col-sm-12'>
								<div class="form-group">
									<label for="travel" class="control-label text-muted">Travel <sup class="text-danger">*</sup></label>
							...
							<div class='col-sm-12'>
								<div class="form-group">
									<label for="nosk" class="control-label text-muted">Nomor surat travel <sup class="text-danger">*</sup></label>
									<input type="text" class="form-control form-text" id="nosurat" name="nosurat"  >
								</div>    
							</div>
							<div class='col-sm-12'>
								<div class="form-group">
									<label for="tglsk" class="control-label text-muted">Tanggal surat travel <sup class="text-danger">*</sup></label>
									<input type="text" class="form-control form-text datepicker" id="tglsurat" name="tglsurat" >
								</div>    
							</div>
							<label class="control-label text-warning mt-4">Identitas Jamaah:</label>
							<div class='col-sm-12'>
								<div class="form-group">
									<label for="jnama" class="control-label text-muted">Nama jamaah <sup class="text-danger">*</sup></label>
									<input type="text" class="form-control form-text" id="jnama" name="jnama" required>
								</div>    
							</div>  
							<div class='col-sm-12'>
								<div class="form-group">
									<label for="jtmplhr" class="control-label text-muted">Tempat lahir jamaah <sup class="text-danger">*</sup></label>
									<input type="text" class="form-control form-text" id="jtmplhr" name="jtmplhr" required>
								</div>    
							</div>   
							<div class='col-sm-12'>
								<div class="form-group">
									<label for="jtgllhr" class="control-label text-muted">Tanggal lahir jamaah <sup class="text-danger">*</sup></label>
									<input type="text" class="form-control form-text datepicker" id="jtgllhr" name="jtgllhr" required>
								</div>    
							</div>   
							<div class='col-sm-12'>
								<div class="form-group">
									<label for="jalamat" class="control-label text-muted">Alamat jamaah <sup class="text-danger">*</sup></label>
									<input type="text" class="form-control form-text" id="jalamat" name="jalamat" required>
								</div>    
							</div> 
							<div class='col-sm-12'>
								<div class="form-group  mb-4">
									<label for="jhp" class="control-label text-muted">Nomor handphone jamaah <sup class="text-danger">*</sup></label>
...
//
	...
	function simpandata(){
		...
		setTimeout(function(){
			$.ajax({
					url:  "<?php echo base_url('index.php/ajax/suruqPost')?>",
					type: 'POST',
					data: formData,
					async: false,
					cache: false,

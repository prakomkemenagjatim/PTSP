					...
					<div class="row justify-content-center">
						...
						<div class='col-sm-6 text-left box-shadow-dark'>
							...
							<header class="section-header mt-4">
								...
								<div class='col-sm-12'>
									<div class="form-group">
										<label for="file1" class="control-label text-muted">Upload Ijazah yang akan dilegalisir <sup class="text-danger">*</sup> <br/> 
...
<script type="text/javascript">
	function simpandata(){
		...
		setTimeout(function(){
			$.ajax({
					url:  "<?php echo base_url('index.php/ajax/paisPost')?>",
					type: 'POST',
					data: formData,
					async: false,
					cache: false,

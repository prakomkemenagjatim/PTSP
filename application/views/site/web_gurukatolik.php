                ...
                <div class="docs-overview py-5">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-2 col-md-4 margin-t-5">  
                            ...
                            onclick="exportexcel($('#tblguruagama'),'data_guruagama_katolik');return false;">
...
<script type="text/javascript">
	...
	function caridata(){
		...
		$('#tblguruagama').datagrid({url:"<?php echo base_url('index.php/ajax/getGuruagamakatolik')?>",queryParams:{
			[csrfName]: csrfHash,
	...
	function getgrafik(dasar){
		host = "<?php echo base_url('index.php/ajax/grafikGuruagamakatolik'); ?>";;
		$.post(host,{
				[csrfName]: csrfHash,
				icari: $('#search_pilih').val(),
				ncari: $('#search').val(),

				...
				<div class="row justify-content-center">
					<div class='col-sm-6 text-left box-shadow-dark'>
						...
						<header class="section-header mt-4">
							...
							<div class='col-sm-12'>
								<div class="form-group">
									<label for="file1" class="control-label text-muted">Upload file surat <sup class="text-danger">*</sup><br/> 
							...
							<div class='col-sm-12'>
								<div class="form-group">
									<label for="file2" class="control-label text-muted">Upload file proposal kegiatan dan denah lokasi <sup class="text-danger">*</sup> <br/> 
									<small>( Tipe file: pdf, Ukuran Maks.: <?php echo sizeupload(); ?> )</small></label>
...
<script type="text/javascript">
	...
	function simpandata(){
		...
		setTimeout(function(){
			$.ajax({
					url:  "<?php echo base_url('index.php/ajax/rekompengajianPost')?>",
					type: 'POST',
					data: formData,
					async: false,
					cache: false,

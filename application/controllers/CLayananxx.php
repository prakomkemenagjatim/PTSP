...
class CLayanan extends Sitecontroller {
	...
	public function sekjen(){
		...
		$data['title'] = $jenis.' ('.$judul.') | KEMENTERIAN AGAMA KOTA MALANG';
		$data['head'] = $jenis;
		$data['subhead'] = $judul;
	...
	public function pd_pontren(){
		...
		$template = $row->layananTemplate;
		if ($template == ''){
			redirect('page/pd-pontren', 'refresh');
		}
		$data['content']='site/'.$template;
		$data['title'] = $jenis.' ('.$judul.') | KEMENTERIAN AGAMA KOTA MALANG';
		$data['head'] = $jenis;
	...
	public function layanan_kristen(){
		...
		$template = $row->layananTemplate;
		if ($template == ''){
			redirect('page/layanan-kristen', 'refresh');
		}
		$data['content']='site/'.$template;
		$data['title'] = $jenis.' ('.$judul.') | KEMENTERIAN AGAMA KOTA MALANG';
		$data['head'] = $jenis;
	...
	public function layanan_buddha(){
		...
		$template = $row->layananTemplate;
		if ($template == ''){
			redirect('page/layanan-buddha', 'refresh');
		}
		$data['content']='site/'.$template;
		$data['title'] = $jenis.' ('.$judul.') | KEMENTERIAN AGAMA KOTA MALANG';
		$data['head'] = $jenis;
	...
	public function layanan_katolik(){
		...
		$template = $row->layananTemplate;
		if ($template == ''){
			redirect('page/layanan-katolik', 'refresh');
		}
		$data['content']='site/'.$template;
		$data['title'] = $jenis.' ('.$judul.') | KEMENTERIAN AGAMA KOTA MALANG';
		$data['head'] = $jenis;
